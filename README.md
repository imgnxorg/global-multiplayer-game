...
```
npm create cloudflare@latest -- --template=cloudflare/templates/global-multiplayer-game
```

A live public deployment of this template is available at [https://global-multiplayer-game.templates.workers.dev](https://global-multiplayer-game.templates.workers.dev)
